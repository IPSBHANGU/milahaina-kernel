...
#define CAM_REQ_MGR_MAX_HANDLES_V2_HAYDN       192
#define CAM_REQ_MGR_MAX_HANDLES_V2_VILI        256
...
struct cam_req_mgr_link_info_v2_haydn {
	__s32 session_hdl;
	__u32 num_devices;
	__s32 dev_hdls[CAM_REQ_MGR_MAX_HANDLES_V2_HAYDN];
	__s32 link_hdl;
};

struct cam_req_mgr_link_info_v2_vili {
	__s32 session_hdl;
	__u32 num_devices;
	__s32 dev_hdls[CAM_REQ_MGR_MAX_HANDLES_V2_VILI];
	__s32 link_hdl;
};
...
struct cam_req_mgr_ver_info {
	...
	union {
		...
		struct cam_req_mgr_link_info_v2_haydn link_info_v2_haydn;
		struct cam_req_mgr_link_info_v2_vili link_info_v2_vili;
	} u;
};
/**
